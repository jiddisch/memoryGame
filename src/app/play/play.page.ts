...
export class PlayPage {
  ...
  constructor(private winRef: WindowService, private router: Router) { }

  ionViewWillEnter(): void {
    this.canvasArea = {width: this.winRef.nativeWindow.innerWidth - 16 - 16, height: this.winRef.nativeWindow.innerHeight - 32};
